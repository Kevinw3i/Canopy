...
- Product Phase 2 exposes MCP foundation tools (`canopy_describe_capabilities`, `canopy_get_guidance`), CloudWatch discovery (`canopy_list_allowed_log_groups`) when MCP CloudWatch is enabled, plus MCP Database v1 when explicitly enabled. CloudWatch search and Insights data access remain Phase 3 work.
