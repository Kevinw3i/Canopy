...
| `mfa_database_url` | -- | Optional SQLite local MFA factor store; WebAuthn registration backend is reserved for localhost browser ceremonies and is not yet exposed as a TUI step-up factor |
