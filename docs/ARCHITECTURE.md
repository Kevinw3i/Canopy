...
| `mfa_database_url` | -- | Optional SQLite local MFA factor store; WebAuthn registration uses a localhost browser ceremony and is not yet exposed as a TUI step-up factor |
